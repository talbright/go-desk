...
func TestCustomerIntegration(t *testing.T) {
	...
	Convey("should be able to create a customer", t, func() {
		customer := desk.NewCustomer()
		customer.FirstName = desk.String("James")
		customer.LastName = desk.String("Dean")
	...
	Convey("should be able to update a customer", t, func() {
		...
		customer := desk.NewCustomer()
		customer.Id = desk.Integer(DefaultCustomerId)
		customer.Background = desk.String(background)
